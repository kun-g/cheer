...
findObjWithKeyPair = spellLib.findObjWithKeyPair
getValidatePlayerSelectPointFilter = spellLib.getValidatePlayerSelectPointFilter
...
describe 'Spell', ->
  ...
  it ' findObjWithKeyPair', ->
    skillData.forEach (e) ->
      ...
      return
    return
  it ' getValidatePlayerSelectPointFilter ', ->
    skillData.forEach (e) ->
      Wizard = require('../js/spell').Wizard
      w = new Wizard
      ret = getValidatePlayerSelectPointFilter(e, w, env)
      console.log ret
      if e.id == 1
        assert ret == null
      else
